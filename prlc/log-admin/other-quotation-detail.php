...
$files = "lhk_files";
$redirect = 'lhk_booking_details.php';
...
$cleaning=$show1['pro_def_rate_rates'];		
...
<form method="post"  action="other_bookquote.php" id="form_list" onsubmit="return checkCheckBoxes(this);">
...
<!--<div class="row">
<span class="label">Pet Fee</span>
<span class="value">$<?php echo $showpet_fee;?></span>
</div> -->
<?php } ?>
<div class="row">
