...
?>
                   ...
                   <!-- <input type="file" class="input" name="ical_file" />-->
                    Ical link: <input class="input" size="65" name="ical_url" value="<?php echo (isset($ical_url) ? $ical_url : @$link ) ?>" type="text">
                    ...
                    <button class="continue-button" type="submit" name="next">Import Calendar</button>
                    </form>
...
function dateToCal($timestamp) {
 ...
 $n = mysqli_query($conn, "SELECT * FROM lhk_contact_details WHERE contact_id='".$pro_id."'");
  @$mm = mysqli_fetch_assoc($n);
  @$email_id = $mm['contact_email'];
// max line length is 75 chars. New line is \\n
$n = mysqli_query($conn, "SELECT * FROM lhk_ical_events WHERE event_pid='".$pro_id."'");
