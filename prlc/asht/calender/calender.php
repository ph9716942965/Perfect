...
$insert = mysqli_query($conn, "SELECT start_date,end_date FROM lhk_ical_events WHERE event_pid='".$myVar."'") or die(mysqli_error($conn));
...
$ser = mysqli_query($conn, "SELECT property_heading FROM lhk_property_details WHERE property_id='".$myVar."'") or die(mysqli_error($conn));
...
<h4 align="center"><strong>Click on available arrival date and then on departure date to make a reservation. </strong></p>
...
<div class="col-md-4 rightButton" style="margin-top: -38px;">
...
<div id="dialog" class="ui-dialog abc col-md-12" title="Basic dialog">
