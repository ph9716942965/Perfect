    ...
    <div class="grid_12">
      <div class="grid_4 footer-column inner-left wow slideInLeft">
        <div class="hotel-contact">
          ...
          <p><a href="about.html">Read more <i class="fa fa-angle-right"></i></a></p> 
        </div>
      </div>
...
<div class="copy-right">
  <div class="container clearfix">
    ...
    <div class="designBy">
      ...
      <span style="color:#AE0000;"><img style="width:165px" src="<?php echo base_url('assets/');?>img/logo.png"></span></a></p>
    </div>
